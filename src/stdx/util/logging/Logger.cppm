...
public:
    ...
    void trace(
        ...
        log(Level::TRACE, fmt, util::forward<Args>(args)..., location);
    }
    ...
    void debug(const FormatString<Args...>& fmt, Args&&... args,
        ...
        log(Level::DEBUG, fmt, util::forward<Args>(args)..., location);
    }
    ...
    void info(
        ...
        log(Level::INFO, fmt, util::forward<Args>(args)..., location);
    }
    ...
    void warn(
        ...
        log(Level::WARNING, fmt, util::forward<Args>(args)..., location);
    }
    ...
    void error(
        ...
        log(Level::ERROR, fmt, util::forward<Args>(args)..., location);
    }
